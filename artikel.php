            ...
            <div class="col-md-8 offset-md-2">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <!-- button -->
                        <a href="index.php" class="btn btn-primary mt-2  w-100">Kembali ke Home</a>
                        <button class="btn btn-primary btn-action mt-2  w-100"
                                onclick="document.location.href='./views/update.php?id=<?php echo $id ?>'">Edit</button>
                            <form action="./controllers/delete.php" method="POST">
                                <input readonly type="hidden" name="id" value="<?= $id ?>">
                                <button class="btn btn-danger btn-action mt-2 w-100" type="submit"
